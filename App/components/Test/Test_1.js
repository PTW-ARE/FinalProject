...
const Test_1 = ({route, navigation }) => {

    const [selectedTest] = useState('T01');
    ...
    const handleNext = () => {
        ...
        navigation.dispatch(
            CommonActions.reset({
                index: 0,
                routes: [
                    { name: 'T02', params: { scores } } // ปรับตามหน้าที่จะไป
                ],
            })
        );
    };
    ...
    return (
        <StyledView className="flex-1 bg-gray-100">
            ...
            <StyledView className='bg-blue-800 p-2 mx-10 mt-5 mb-1 rounded-xl'>
                <StyledText className='text-white text-center text-2xl font-bold '>
                    แบบทดสอบหลังเรียนข้อที่1
                </StyledText>
            </StyledView>

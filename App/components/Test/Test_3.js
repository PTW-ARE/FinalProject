...
const Test_3 = ({ route, navigation }) => {

    const [selectedTest] = useState('T03');
    ...
    const handleNext = () => {
        ...
        navigation.dispatch(
            CommonActions.reset({
                index: 0,
                routes: [
                    { name: 'T04', params: { scores } } // ปรับตามหน้าที่จะไป
                ],
            })
        );
    };
            ...
            <StyledView className='bg-orange-200 mx-4 mt-1 mb-4 h-2/3 rounded-2xl'>
                ...
                <StyledView className='mt-5'>
                    <StyledTouchableOpacity
                        onPress={() => handleChoice('Choice1', false)}

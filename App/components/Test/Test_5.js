...
const Test_5 = ({ navigation }) => {

    const [selectedTest] = useState('T05');
                ...
                <StyledView className='mt-5'>
                    <StyledTouchableOpacity>
                        {tests
                            .filter((test) => test.TestID === selectedTest)
                            .map((test) => (
                                <StyledText key={test.TestID} className='bg-blue-500 text-lg text-white my-4 ml-4 w-1/2 pl-4 py-2 rounded-2xl'>
                                    1.{test.Choice1}
                                </StyledText>
                            ))}
                    </StyledTouchableOpacity>
